...
def run_test_count_cosines_from():
    ...
    # Test 5:
    expected = 12
    answer = count_cosines_from(-2, 9, -1.01)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 0
    answer = count_cosines_from(20, 40, 1.01)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 0.5  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(2, 2)
